...
\begin{itemize}[leftmargin=2pt, itemsep=6pt, parsep=0.2pt, topsep=1pt]
	...
	\item[] Data-driven Medical Decision Making; Healthcare Operations Management; Empirical Healthcare Operations
...
\vspace*{0.4em}
\hrule height 0.5pt
\begin{enumerate}[leftmargin=18pt, itemsep=6pt, parsep=0.2pt, topsep=1pt]
...
\vspace*{0.4em}
\hrule height 0.5pt
\begin{itemize}[leftmargin=15pt, itemsep=8pt, parsep=0.2pt, topsep=1pt]
...
\begin{itemize}[leftmargin=15pt, itemsep=0pt, parsep=0.2pt, topsep=1pt]
...
\begin{itemize}[leftmargin=15pt, itemsep=2pt, parsep=0pt, topsep=-0.5em]
...
\vspace*{0.4em}
\hrule height 0.5pt
\begin{itemize}[leftmargin=15pt, itemsep=1pt, parsep=0.5pt, topsep=1pt]
