...
\setlist[enumerate,1]{leftmargin=30pt, itemsep=4pt} % Enumerate Level 1
...
{\footnotesize \href{mailto:gcheng@u.nus.edu}{gcheng@u.nus.edu}} $\ \vert \ $ \footnotesize{\href{https://gcheng.org}{https://gcheng.org}} \\
\vspace*{0.5em}
...
\begin{enumerate}[leftmargin=30pt, resume]
	...
	\href{https://ssrn.com/abstract=4956298}{The Role of Contextual Information in Customer Reviews: A Field Experiment on a Mental Health Platform.} Under 2nd round revision at \textit{\textbf{Management Science}}.

	\begin{itemize}
		\item {\footnotesize Finalist, 2025 POMS PITM Best Student Paper Competition}
		\item {\footnotesize Selected for presentation at Workshop on Empirical Operations Management 2025}
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item DOS3703 Service Operations Management (BBA) \hfill Spring 2026
...
\begin{itemize}
	...
	\begin{itemize}
		\item POMS Annual Conference, Reno, Nevada, USA \hfill May 2026
		\item The 16th POMS-HK International Conference, Shenzhen, China \hfill Jan 2026
		\item INFORMS Annual Meeting, Atlanta, Georgia, USA \hfill Oct 2025
