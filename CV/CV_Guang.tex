...
\begin{itemize}
    \item[] \textbf{Topics:} Data-Driven Operations in Healthcare; Behavioral Interventions; Mental Health Platforms
...
\begin{enumerate}
	...
	\item Guang Cheng, Jingui Xie, Zhichao Zheng, $^P$Haidong Luo, $^P$Oon-Cheong Ooi.
	...
	\textit{\textbf{Management Science}}. 2024. Article in Advance.
	
	\item $^P$Stephanie Q. Ko, Guang Cheng, $^P$Tze Yeong Teng, Joel Goh.
	...
	\item Jingui Xie, Guang Cheng, Zhichao Zheng, $^P$Haidong Luo, $^P$Oon-Cheong Ooi. 
...
\begin{enumerate}[leftmargin=30pt, resume]
	...
	\item Retain Clients on Mental Health Platforms Using Behavioral Nudges (with S\i{}d\i{}ka Tun\c{c} Cando\u{g}an and Yueyang Zhong) 
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item MSOM Conference, London, UK (scheduled) \hfill June 2025
